...
import { AspectRatio, Box, Card, Grid, IconButton, Typography } from '@mui/joy'
...
function InputListItem(props: InputListItemProps) {
    ...
    return (
        <Card
            ...
            variant="outlined"
            color="neutral"
            sx={{ border: 'none', width: '100%', background: 'transparent' }}
        >
            ...
            >
                ...
                >
                    <Grid
                        ...
                        alignItems="center"
                        justifyContent="center"
                        id="create-chapter-img-wrapper"
                    >
                        {resultMap.get(counter) &&
                        resultMap.get(counter).preview ? (
                            <img
                ...
                <UploadImage
                    open={
                        resultMap.get(counter) &&
                        resultMap.get(counter).openUpload
                    }
                    close={() =>
                        setResultMap((newResultMap) => {
                            newResultMap.set(counter, {
