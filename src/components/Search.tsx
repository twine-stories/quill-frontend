                        ...
                        <>
                         <AutocompleteOption {...props}>    
                           <div className="optionss" 
                                style={{ display: 'flex', flexDirection: 'column', alignItems: 'left', gap: '0px'}}
                                >
                                    <span className="options-name" 
                                    style={{  fontStyle: "Oxanium", fontSize: "18px", padding:'5px 10px 0px'  }}
                                    >{option.name}</span>
                                    <Typography level="body3" sx={{ margin: '1px' }}>
                                        <span className="options-name" 
                                        style={{  fontStyle: "Oxanium", fontSize: "12px",padding:'5px 10px 0px' }}
                                        >{option.isWork ? "Story" : "User"}</span>
                                    </Typography>
                                </div>
                            </AutocompleteOption>
                        </>
