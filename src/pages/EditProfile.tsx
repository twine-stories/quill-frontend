                    ...
                    <Grid>
                        ...
                        >
                            <Grid>
                                <Textarea
                                    className="website"
                                    defaultValue={user && "https://" + user.website}
                            ...
                            <Grid>
                                <Textarea
                                    className="twitter"
                                    defaultValue={user && "https://twitter.com/" + user.twitter}
                            ...
                            <Grid>
                                <Textarea
                                    className="instagram"
                                    defaultValue={user && "https://instagram.com/" + user.instagram}
                            ...
                            <Grid>
                                <Textarea
                                    className="reddit"
                                    defaultValue={user && "https://reddit.com/u/" + user.reddit}
