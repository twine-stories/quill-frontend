...
function CreateChapter(props: CreateChapterProps) {
            ...
            if (content === '!BAD!') {
                ...
                if (!display) {
                    ...
                    compoundedElements.push(
                        CHAPTER_IMG_DELIMETER + content['name']
                    )
                } else {
    ...
    async function checkCollaborators(): Promise<Map<User, number>> {
        ...
        if (sum !== 100) {
            ...
            setErrorMessage(
                'The total share of all the collaborators is not 100%!'
            )
            setOpenError(true)
            return null
        }
        ...
        for (let i = 0; i < usernames.length; i++) {
            if (usernames[i] === '') {
                setErrorMessage(
                    'A username you entered as a collaborator is empty!'
                )
                setOpenError(true)
                return null
            }
            ...
            if (response) {
                ...
                setErrorMessage(
                    'A username you entered as a collaborator is invalid.'
                )
                setOpenError(true)
                return null
            }
