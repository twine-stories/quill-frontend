        ...
        <div>
            ...
            <Grid container direction='column' alignItems='center' justifyContent='space-around'>
                ...
                <Grid container direction='column' alignItems='center' justifyContent='space-around' xs={11} rowSpacing={3}>
                    ...
                    <Grid container direction='column' alignItems='center' justifyContent='space-around' xs={11} id='feedback-upload-wrapper'>
                        <Grid xs={12}>
                            <Typography level='h3' color='purple'>Image of Issue (Optional)</Typography>
                        </Grid>
                        <Grid container alignItems='center' justifyContent='center' id='feedback-image-upload'>
                            {feedbackImg.preview ? 
                                <img
                                    src = {feedbackImg.preview}
                                    alt = ""
                                    onClick = {() => setFeedbackImg({
                                        ...feedbackImg,
                                        openUpload: true
                                    })}
                                    id='feedback-upload'
                                />
                                :
                                <TwineButton icon='/icons/purple_plus_light.svg' name='Upload' color='darkpurple' action={() => setFeedbackImg({
                                    ...feedbackImg,
                                    openUpload: true
                                })} />
                            }
                    ...
                    <Grid container alignItems='center' justifyContent='space-around' xs={11}>
                        <TwineButton name='Submit' color='darkpurple' action={() => {
                            ...
                            const feedback: Feedback = {
                                ...
                                subject: subj,
                                description: desc,
                                images: feedbackImg.name ? feedbackImg.name : null
                            };
