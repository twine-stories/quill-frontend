        ...
        <div>
            ...
            <Grid container direction='column' alignItems='center' justifyContent='space-around'>
                ...
                <Grid xs={10} id='terms-links'>
                    ...
                    <a href={legalUrl + docMapping['community'] + '.pdf'} target='_blank'>
                        <Typography level='h4'>Community Policy</Typography>
                    </a>
                    <a href={legalUrl + docMapping['privacy'] + '.pdf'} target='_blank'>
                        <Typography level='h4'>Privacy Policy</Typography>
                    </a>
                    <a href={legalUrl + docMapping['revenue'] + '.pdf'} target='_blank'>
                        <Typography level='h4'>Revenue Terms of Service</Typography>
                    </a>
                </Grid>
            </Grid>
        </div>
