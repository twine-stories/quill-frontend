...
const mnemonic: string =
    'muscle glad denial accuse process name law hover pink siege fabric away suggest when guard tip jelly firm toast stomach foil extra spoil absent swarm'

export const zeroAddr: string =
